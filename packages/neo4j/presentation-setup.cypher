...
create
    ...
    (Tour5:Info {name:"There are :Info Pages with a single :NEXT link.", image:"https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/Placeholder_view_vector.svg/638px-Placeholder_view_vector.svg.png"}),
    (Tour6:Decision {name:"We have :Decision Pages with a :YES and a :NO link. Cool?", image:"https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/Placeholder_view_vector.svg/638px-Placeholder_view_vector.svg.png"}),
    ...
    (Tour7:Navigation {name:"We have :Navigation Pages with more than one named :LINK", image:"https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/Placeholder_view_vector.svg/638px-Placeholder_view_vector.svg.png"}),
    ...
    (Tour17:Info {name:":Factory has a :CREATES link to a (Ontology) :Type", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/Placeholder_view_vector.svg/638px-Placeholder_view_vector.svg.png"}),
    (Tour18:Info {name:"An (Ontology) :Type :HAS :Property and :Reference nodes.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/Placeholder_view_vector.svg/638px-Placeholder_view_vector.svg.png"}),
    (Tour18_prop:Info {name:"A :Property is a literal Value like a String, Date, Boolean, etc. (primitive Data Type)", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/Placeholder_view_vector.svg/638px-Placeholder_view_vector.svg.png"}),
    (Tour18_ref:Info {name:"A :Reference means the :Type is linked with other Types (composite Data Type).", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/Placeholder_view_vector.svg/638px-Placeholder_view_vector.svg.png"}),
    ...
    (Tour20:Info {name:"We save the lovely semantic Data (Person, Appointment, ...) to our Knowledge Graph."}),
    ...
    (Tour25:Info {name:"(2. Ontology Graph) - Schema nodes, like :Type, :Property, :Reference. They define the semantic Data Structure that a :Factory creates."}),
    (Tour26:Info {name:"(3. Knowledge Graph) - The Users personal Knowledge Graph. It is enriched by the user through navigation and use of the :Factory."}),
    ...
    (Tour16) -[:NEXT]-> (Tour17),
    (Tour17) -[:NEXT]-> (Tour18),
    (Tour18) -[:NEXT]-> (Tour18_prop),
    (Tour18_prop) -[:NEXT]-> (Tour18_ref),
    (Tour18_ref) -[:NEXT]-> (Tour19),
    (Tour19) -[:NEXT]-> (Tour20),
    (Tour20) -[:NEXT]-> (Tour21),
    (Tour21) -[:NEXT]-> (Tour22),
    (Tour22) -[:YES]-> (Tour23),
